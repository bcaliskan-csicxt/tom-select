...
import select_all_button from './plugins/select_all_button/plugin';
import action_hooks from './plugins/action_hooks/plugin';
...
TomSelect.define('select_all_button', select_all_button);
TomSelect.define('action_hooks', action_hooks);
